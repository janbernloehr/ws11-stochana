...
Prozess}\index{Prozess!stochastischer} $X$ auf $(\Omega, \Fc,P)$ ist eine
...
Es handelt sich hierbei um eine echte Einschränkung, denn $\Fc_t \subset\Fc$,
...
\nomenclature{$\Fc_T$}{$\sigma$-Algebra der $T$ Vergangenheit}
\label{defn:1.10}
